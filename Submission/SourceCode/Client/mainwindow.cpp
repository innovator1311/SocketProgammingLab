  ...
  : QMainWindow(parent)
{
  ...
  skip_answer->setGeometry(QRect(QPoint(200, 350), QSize(100, 30)));
  ...
  connect(listen_button, &QPushButton::released, this, &MainWindow::handleConnect);
...
void MainWindow::handleConnect() {
    ...
    if (::connect(sockfd, (struct sockaddr *) &serv_addr, sizeof(serv_addr)) < 0) {
        console_view->setText("Server is not ready yet\n");
        connecting = false;
        return;
